...
ancestral_DNA = 'BB BBBABBBA AA BBAA BBBAADAADADDAA'
...
for generation in range(GENERATION_TIME):
    ...
    daughter_DNA = [daughter_DNA.append(copySequenceWithErrors(solution.cells[int(n/2)].DNA)) for n in range(NUMBER_OF_CELLS)]