...
#solution.volume /= 64
solution.setMetabolites('default')
...
'Gen 263': 'BACBDCBDDAABAADBBAACADACDDBDBBBAACDDCAADDDAABCABDDAABABDBCAACAAADCDCABACDCABBACDDAABABDBBADDBCDDAABABDBBADDBDADBABCBABDDAABABDBCAADADCAADBDBCBAADDDCABCCACCCAADBDADBDBCBAACCAADBA'}
